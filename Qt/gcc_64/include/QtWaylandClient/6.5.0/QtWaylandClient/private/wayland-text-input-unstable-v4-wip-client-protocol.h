...
{
	wl_proxy_marshal((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_DESTROY);

	wl_proxy_destroy((struct wl_proxy *) zwp_text_input_v4);
}
...
{
	wl_proxy_marshal((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_SURROUNDING_TEXT, text, cursor, anchor);
}
...
{
	wl_proxy_marshal((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_TEXT_CHANGE_CAUSE, cause);
}
...
{
	wl_proxy_marshal((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_CONTENT_TYPE, hint, purpose);
}
...
{
	wl_proxy_marshal((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_CURSOR_RECTANGLE, x, y, width, height);
}
...
{
	wl_proxy_marshal((struct wl_proxy *) zwp_text_input_manager_v4,
			 ZWP_TEXT_INPUT_MANAGER_V4_DESTROY);

	wl_proxy_destroy((struct wl_proxy *) zwp_text_input_manager_v4);
}
...
zwp_text_input_manager_v4_get_text_input(struct zwp_text_input_manager_v4 *zwp_text_input_manager_v4, struct wl_seat *seat)
{
	...
	id = wl_proxy_marshal_constructor((struct wl_proxy *) zwp_text_input_manager_v4,
			 ZWP_TEXT_INPUT_MANAGER_V4_GET_TEXT_INPUT, &zwp_text_input_v4_interface, NULL, seat);
