...
set_target_properties(Qt6::LabsSharedImage PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage.so.6.5.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6LabsSharedImage.so.6"
  )

list(APPEND _cmake_import_check_targets Qt6::LabsSharedImage )
list(APPEND _cmake_import_check_files_for_Qt6::LabsSharedImage "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage.so.6.5.0" )
