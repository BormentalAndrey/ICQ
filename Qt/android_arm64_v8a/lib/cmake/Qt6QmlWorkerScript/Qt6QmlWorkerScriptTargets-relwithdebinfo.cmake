...
set_target_properties(Qt6::QmlWorkerScript PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6QmlWorkerScript_arm64-v8a.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6QmlWorkerScript_arm64-v8a.so"
  )

list(APPEND _cmake_import_check_targets Qt6::QmlWorkerScript )
list(APPEND _cmake_import_check_files_for_Qt6::QmlWorkerScript "${_IMPORT_PREFIX}/lib/libQt6QmlWorkerScript_arm64-v8a.so" )
