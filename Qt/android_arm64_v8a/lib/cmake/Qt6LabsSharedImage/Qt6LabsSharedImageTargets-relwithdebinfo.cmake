...
set_target_properties(Qt6::LabsSharedImage PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage_arm64-v8a.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6LabsSharedImage_arm64-v8a.so"
  )

list(APPEND _cmake_import_check_targets Qt6::LabsSharedImage )
list(APPEND _cmake_import_check_files_for_Qt6::LabsSharedImage "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage_arm64-v8a.so" )
