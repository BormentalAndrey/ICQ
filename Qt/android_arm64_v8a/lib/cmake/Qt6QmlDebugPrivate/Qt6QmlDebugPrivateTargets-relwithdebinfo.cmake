...
set_target_properties(Qt6::QmlDebugPrivate PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6QmlDebug_arm64-v8a.a"
  )

list(APPEND _cmake_import_check_targets Qt6::QmlDebugPrivate )
list(APPEND _cmake_import_check_files_for_Qt6::QmlDebugPrivate "${_IMPORT_PREFIX}/lib/libQt6QmlDebug_arm64-v8a.a" )
