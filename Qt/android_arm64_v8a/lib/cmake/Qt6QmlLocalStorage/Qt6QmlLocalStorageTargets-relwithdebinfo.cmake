...
set_target_properties(Qt6::QmlLocalStorage PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6QmlLocalStorage_arm64-v8a.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6QmlLocalStorage_arm64-v8a.so"
  )

list(APPEND _cmake_import_check_targets Qt6::QmlLocalStorage )
list(APPEND _cmake_import_check_files_for_Qt6::QmlLocalStorage "${_IMPORT_PREFIX}/lib/libQt6QmlLocalStorage_arm64-v8a.so" )
